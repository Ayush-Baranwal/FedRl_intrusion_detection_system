...
class IntrusionClient(fl.client.NumPyClient):
    def __init__(self) -> None:
        random_seed = 0
        dqn_config = DQNConfig(input_dim=242, defender_output_dim=242, hidden_dim=32, replay_memory_size=10000,
                               num_hidden_layers=1,
        ...
        q_agent_config = QAgentConfig(gamma=0.999, alpha=0.00002, epsilon=1, render=False, eval_sleep=0.9,
                                      ...
                                      eval_frequency=100, attacker=False, defender=True, video_frequency=101,
                                      save_dir="./results/data", dqn_config=dqn_config,
                                      checkpoint_freq=1000)
        env_name = "idsgame-maximal_attack-v14"
